  ...
  return (
    <div>
      ...
      <MainContainer bg={theme?.main?.bg}>
          ...
          <h1 className='about-heading'>✨ Why did I build this?</h1>
          <div className='box-container'>
          ...
          <h1 className='about-heading'>📋 What can you do here?</h1>
          ...
          <h1  className='about-heading'>🚀 How to make the most of it?</h1>
          ...
          <h1  className='about-heading'>👨‍💻 Who is this for?</h1>
          ...
          <h1  className='about-heading'>💌 Final words from me</h1>
          <div className='box-container'>
